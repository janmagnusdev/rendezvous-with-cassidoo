...
export const convertNumberToWords = (number: number): string => {
  ...
  if (number < 1_000) {
    ...
    return tens === 0
      ...
      : `${convertNumberToWords(hundreds)} hundred ${convertNumberToWords(
          tens
        )}`;
  }
  if (number < 1_000_000) {
    ...
    return hundreds === 0
      ...
      : `${convertNumberToWords(thousands)} thousand ${convertNumberToWords(
          hundreds
        )}`;
  }
  if (number < 1_000_000_000) {
    ...
    return thousands === 0
      ...
      : `${convertNumberToWords(millions)} million ${convertNumberToWords(
          thousands
        )}`;
  }
  if (number < 1_000_000_000_000) {
    ...
    return millions === 0
      ...
      : `${convertNumberToWords(billions)} billion ${convertNumberToWords(
          millions
        )}`;
  }
  if (number < 1_000_000_000_000_000) {
    ...
    return billions === 0
      ...
      : `${convertNumberToWords(trillions)} trillion ${convertNumberToWords(
          billions
        )}`;
  }
